...
Neste _post_ eu irei dar uma ideia geral do conceito de moeda, suas características desejáveis, comparação com moedas fiduciárias (aquelas emitidas por um ente centralizador como o governo, no nosso caso) e apontar alguns dados sobre a realidade monetária.
...
Acredito muito na importância da consistência lógica, isto é, se você entende que 1 + 1 = 2, então deve entender que 2 + 2 = 4, _ceteris paribus_. É uma dedução lógica. O problema é que nem sempre isso acontece. Existem muitos exemplos, mas para esse post vamos focar na questão monetária.
...
![Histórico de juros do Brasil](/images/blog/meta-selic.png)

_Figura 2. Meta para a taxa de Selic._
...
![Desvalorização do Real desde 1994](/images/blog/27-anos-plano-real.jpg)

_Figura 3. Desvalorização do Real desde 1994._

Já nos Estados Unidos, um dólar hoje equivale a 26,14 dólares em 1913.

![Desvalorização do Dólar desde 1913](/images/blog/purchasing-power-of-the-us-dollar.jpg)

_Figura 4. Desvalorização do Dólar desde 1913._
