...
excerpt: "Build a minimal proof-of-work blockchain in Python with Block and Blockchain classes, SHA-256 hashing, and a full unittest suite."
---

In the previous post we discussed some concepts in regard to blockchain. If you missed [this post](/blog/introduction-to-blockchain), I strongly suggest you to go back and take a read before moving forward.
...
![Blockchain's UML](/images/blog/blockchain-uml.jpg)

_Figure 1. Diagram of block and blockchain classes._
...
_Table 1. Difficulty vs. time (s) comparison._
